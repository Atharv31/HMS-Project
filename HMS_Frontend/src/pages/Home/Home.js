...
import sample1 from "../../assets/BG3.jpg";
import sample2 from "../../assets/BG2.jpg";
import sample3 from "../../assets/BG1.jpg";
      ...
      <div className="container marketing service-container">
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="service-item">
              <h2>Contact Us</h2>
              Address: Healthcare Multispeciality Hospital
              <br />Hinjewadi Phase 2, Pune
              <br />Pin - 131101
              <br />Toll Free No - 1800 402 4444
              <br />Tel No - +91 14099156
              <br />Email - Healthcare@gmail.com
            </div>
          </div>
          <div className="col-lg-4">
            <div className="service-item">
